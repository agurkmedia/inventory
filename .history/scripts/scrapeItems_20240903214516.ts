...
async function scrapeItems() {
  try {
    ...
    $('.item').each((index, element) => {
      ...
      items.push({ name, description, quantity, imageUrl, productCode, price, weight, availability, manufacturer, attenuation, flocculation, usageDirections, storageRecommendations, desinfisering, contactTime });
    });
