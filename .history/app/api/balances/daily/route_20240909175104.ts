...
export async function GET(req: Request) {
  ...
  try {
    // Use startOfMonth and endOfMonth to get precise dates for the month
    ...
    // Loop to ensure that the last day of the month is included and the previous month's day is excluded
