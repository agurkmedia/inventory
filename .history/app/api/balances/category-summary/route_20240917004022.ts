...
export async function GET(req: Request) {
    ...
    try {
        ...
        expenses.forEach(expense => {
            ...
            const amount = Math.abs(expense.amount); // Ensure amount is positive
            ...
            categoryTotals[category].net -= amount; // Subtract expense from net
        });
        ...
        incomes.forEach(income => {
            ...
            const amount = Math.abs(income.amount); // Ensure amount is positive
            totalIncome += amount;
            ...
            categoryTotals[source].net += amount; // Add income to net
        });
        ...
        receiptItems.forEach(item => {
            ...
            if (amount > 0) {
                ...
                // Income (refund)
                const incomeAmount = -amount; // Convert to positive
