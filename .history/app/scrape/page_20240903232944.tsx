            ...
            <div>
              ...
              <div className="overflow-x-auto">
                <table className="min-w-full bg-white bg-opacity-10 backdrop-filter backdrop-blur-lg rounded-xl shadow-2xl">
                  ...
                  <tbody>
                    {scrapedData.map((itemUrl, index) => (
                      <tr key={index}>
                        <td className="border px-4 py-2 text-white">
                          <a href={itemUrl} target="_blank" rel="noopener noreferrer" className="text-indigo-400 hover:text-indigo-300">
                            {itemUrl}
                          </a>
                        </td>
                      </tr>
              ...
              <p className="text-white mt-4">Total item links: {scrapedData.length}</p>
            </div>
          )}
        </div>
      </motion.div>
