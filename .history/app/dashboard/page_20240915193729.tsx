...
export default function Dashboard() {
  ...
  const ensureReceiptsInventory = useCallback(async () => {
    ...
    try {
      ...
      console.log('Receipts inventory ensured:', data);
    } catch (err) {
  ...
  const fetchDashboardData = useCallback(async () => {
    ...
    try {
      await ensureReceiptsInventory(); // Ensure Receipts inventory exists
  ...
  }, [session, ensureReceiptsInventory]);
