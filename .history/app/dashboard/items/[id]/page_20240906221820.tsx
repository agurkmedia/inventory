  ...
  return (
    <div className="bg-white bg-opacity-10 backdrop-filter backdrop-blur-lg rounded-xl p-8 shadow-xl max-w-2xl mx-auto mt-10">
      ...
      <div className="space-y-6">
        ...
        <p className="text-indigo-200"><strong>Created At:</strong> {new Date(item.createdAt).toLocaleString()}</p>
        <p className="text-indigo-200"><strong>Last Updated:</strong> {new Date(item.updatedAt).toLocaleString()}</p>
      </div>
