    ...
    return new Promise((resolve) => {
      ...
      reader.onload = async () => {
        ...
        for (let pageNum = 1; pageNum <= pdf.numPages; pageNum++) {
          ...
          const { data } = await Tesseract.recognize(dataURL, 'nor', {
        ...
        <div className="text-gray-700 mb-4">
          ...
          {method === 'ocr' && (
            <p className="text-sm text-gray-500">
              Note: OCR may take a while for large files.
            </p>
          )}
        </div>
      )}
      {!loading && (
        <>
          {Object.keys(groupedTransactions).length > 0 && (
            <div className="mb-4">
              <h2 className="text-lg font-bold mb-2">Grouped Transactions</h2>
                ...
                <div key={groupKey} className="mb-4">
                  ...
                  >
                    ...
                    <span className="text-gray-700">
                      {group.totalAmount.toFixed(2)} NOK
                    </span>
                  </div>
                    ...
                    <div className="mt-2">
                      <table className="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody className="bg-white divide-y divide-gray-200">
                          {group.transactions.map((transaction: ParsedTransaction, index: number) => (
                            <tr key={index}>
