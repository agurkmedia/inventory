...
export default function ImportPDF() {
  ...
  const [groupedTransactions, setGroupedTransactions] = useState<Record<string, GroupedTransaction>>({});
  ...
  const handleSaveGrouping = async (groupKey: string) => {
    try {
      ...
      const descriptions = Array.from(new Set(group.transactions.map((t) => t.description.trim())));
