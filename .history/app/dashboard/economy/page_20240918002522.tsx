  ...
  const renderPieChart = (data: { [key: string]: number }, title: string) => {
    ...
    const options = {
      ...
      plugins: {
        ...
        title: {
          display: true,
          text: `${title} (Total: $${Math.abs(Object.values(data).reduce((sum, val) => sum + val, 0)).toFixed(2)})`,
          color: 'white',
          font: { size: 16 },
        },
      },
  ...
  return (
    <div className="space-y-4 h-full">
      ...
      <div className="flex flex-wrap gap-2 mb-4">
        ...
        <Link href="/dashboard/economy/import-pdf" className="bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded transition duration-150 ease-in-out text-sm">
