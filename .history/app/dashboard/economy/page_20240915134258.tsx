...
export default function EconomyAndBudget() {
  ...
  const renderReceiptBreakdown = () => {
    // Check if receipts or breakdown is undefined
    if (!categorySummary.receipts || !categorySummary.receipts.breakdown) {
      return (
        <tr>
    ...
    // Check if breakdown is an array
    if (Array.isArray(categorySummary.receipts.breakdown)) {
