          ...
          <li key={receipt.id} className="bg-white bg-opacity-10 p-4 rounded">
            {editingReceipt?.id === receipt.id ? (
              ...
              <>
                ...
                <div className="mt-2">
                  <Link href={`/dashboard/economy/receipts/${receipt.id}/add-item`} className="text-green-500 mr-2">
                    Add Item
                  </Link>
                  <button onClick={() => setEditingReceipt(receipt)} className="text-blue-500 mr-2">Edit</button>
