      ...
      Papa.parse(file, {
        complete: (results) => {
          try {
            ...
            // Debugging: Log parsed transactions
            ...
            const newTransactions = parsed.filter((transaction) => {
              ...
              // Debugging: Log group key and check processed groups
              ...
              if (processedGroups.includes(groupKey)) {
                ...
                return false; // Skip already processed groups
              }
              ...
              // Debugging: Log if the transaction exists
              console.log(`Transaction exists: ${exists}`);
              return !exists; // Return true if it doesn't exist in the database
            });
