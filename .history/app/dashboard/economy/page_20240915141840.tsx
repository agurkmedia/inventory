      ...
      <div className="bg-white bg-opacity-10 backdrop-filter backdrop-blur-lg rounded-lg p-4 shadow-md">
        <div className="flex justify-between items-center cursor-pointer" onClick={() => toggleSection('dailyBalance')}>
          ...
          <div>
            {viewMode === 'yearly' ? (
              <>
                <button onClick={() => handleYearChange(-1)} className="bg-blue-500 text-white px-2 py-1 rounded mr-2">Previous Year</button>
                <span className="text-white">{selectedMonth.getFullYear()}</span>
                <button onClick={() => handleYearChange(1)} className="bg-blue-500 text-white px-2 py-1 rounded ml-2">Next Year</button>
              </>
            ) : (
              <>
                <button onClick={handlePreviousMonth} className="bg-blue-500 text-white px-2 py-1 rounded mr-2">Previous Month</button>
