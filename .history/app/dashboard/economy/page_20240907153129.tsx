      ...
      <div className="bg-white bg-opacity-10 backdrop-filter backdrop-blur-lg rounded-lg p-4 shadow-md">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {['Daily', 'Weekly', 'Monthly', 'Quarterly', 'Yearly'].map((period) => (
            <div key={period} className="aspect-w-16 aspect-h-9">
              <h3 className="text-md font-semibold text-white mb-1">{period}</h3>
              <Line 
                data={{
                  labels: projectionChartData[period.toLowerCase()].labels,
                  datasets: [{
                    label: 'Balance',
                    data: projectionChartData[period.toLowerCase()].data,
                ...
                options={{
                  ...
                  scales: {
                    x: { ticks: { color: 'white', maxTicksLimit: 5 } },
                    y: { ticks: { color: 'white' } }
                  }
                }}
              />
