...
import { updateBalances } from '@/utils/balanceUpdater'; // Import the balance updater
...
export default function EconomyAndBudget() {
  ...
  const initializeBalances = async () => {
    try {
      ...
      // Call the balance updater function
      await updateBalances(session.user.id, new Date());
    } catch (err) {
