...
export default function EconomyAndBudget() {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-3xl font-bold text-white mb-6">Economy & Budget</h1>
      ...
      <div className="flex flex-col sm:flex-row justify-between space-y-4 sm:space-y-0 sm:space-x-4">
        <Link href="/dashboard/economy/new-transaction" className="bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded transition duration-150 ease-in-out text-center">
          Add New Transaction
        </Link>
        <Link href="/dashboard/economy/set-income" className="bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-4 rounded transition duration-150 ease-in-out text-center">
          Set Income
        </Link>
      </div>
    </div>
