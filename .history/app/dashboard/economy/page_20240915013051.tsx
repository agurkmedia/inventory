...
export default function EconomyAndBudget() {
  ...
  const handleViewChange = (mode: 'daily' | 'monthly' | 'yearly') => {
    setViewMode(mode);
    // Here you would fetch data based on the new view mode
    // For example:
    // fetchData(mode, startDate, endDate);
  };
    ...
    <div className="space-y-4 h-full">
      ...
      <div className="bg-white bg-opacity-10 backdrop-filter backdrop-blur-lg rounded-lg p-4 shadow-md">
        <div className="flex justify-between items-center">
          <h2 className="text-lg font-semibold text-white">Current Month Summary</h2>
          <div>
