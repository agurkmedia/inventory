...
export default function EconomyAndBudget() {
  ...
  const renderBarChart = () => {
    const expenseTotal = Object.values(categorySummary.expenses.breakdown).reduce(
      (sum, value) => sum + value,
      0
    );
    ...
    const chartData = {
      ...
      datasets: [
        {
          label: 'Amount',
          data: [categorySummary.incomes.total, expenseTotal],
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-white bg-opacity-10 rounded-lg p-4 shadow-md">
        <h2 className="text-lg font-semibold text-white mb-2">Balance Summary</h2>
