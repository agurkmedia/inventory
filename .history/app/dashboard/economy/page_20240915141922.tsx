    ...
    <div className="space-y-4 h-full">
      ...
      <div className="bg-white bg-opacity-10 backdrop-filter backdrop-blur-lg rounded-lg p-4 shadow-md">
        <div className="flex justify-between items-center cursor-pointer" onClick={() => toggleSection('financialSummary')}>
          ...
          {collapsedSections.financialSummary ? <ChevronDownIcon className="h-5 w-5 text-white" /> : <ChevronUpIcon className="h-5 w-5 text-white" />}
        </div>
      ...
      <div className="bg-white bg-opacity-10 backdrop-filter backdrop-blur-lg rounded-lg p-4 shadow-md">
        <div className="flex justify-between items-center cursor-pointer" onClick={() => toggleSection('expenseBreakdown')}>
          ...
          {collapsedSections.expenseBreakdown ? <ChevronDownIcon className="h-5 w-5 text-white" /> : <ChevronUpIcon className="h-5 w-5 text-white" />}
        </div>
      ...
      <div className="bg-white bg-opacity-10 backdrop-filter backdrop-blur-lg rounded-lg p-4 shadow-md">
        <div className="flex justify-between items-center cursor-pointer" onClick={() => toggleSection('dailyBalance')}>
          ...
          {collapsedSections.dailyBalance ? <ChevronDownIcon className="h-5 w-5 text-white" /> : <ChevronUpIcon className="h-5 w-5 text-white" />}
        </div>
        {!collapsedSections.dailyBalance && (
          <>
            {/* ... existing daily balance chart content ... */}
          </>
        )}
      </div>
      ...
      <div className="bg-white bg-opacity-10 backdrop-filter backdrop-blur-lg rounded-lg p-4 shadow-md">
        <div className="flex justify-between items-center cursor-pointer" onClick={() => toggleSection('dailyBalanceTable')}>
          ...
          {collapsedSections.dailyBalanceTable ? <ChevronDownIcon className="h-5 w-5 text-white" /> : <ChevronUpIcon className="h-5 w-5 text-white" />}
        </div>
        {!collapsedSections.dailyBalanceTable && (
          <>
            {/* ... existing daily balance table content ... */}
          </>
        )}
      </div>
    </div>
